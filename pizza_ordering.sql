...
CREATE TABLE `customer` (
  ...
  `ten_pizza_discount_used` int DEFAULT NULL,
...
INSERT INTO `customer` VALUES (1,'Mario','Rossi','1985-05-15','Via Roma 123','+1234567890',1,0),(2,'Luigi','Bianchi','1990-08-22','Via Milano 456','+1234567891',1,0),(3,'Maria','Verdi','1988-03-10','Via Napoli 789','+1234567892',0,0),(4,'Giulia','Neri','1995-01-20','Via Torino 111','+1234567893',0,0),(5,'Paolo','Ricci','1982-11-02','Via Firenze 222','+1234567894',1,0),(6,'Francesca','Marino','1991-07-07','Via Venezia 333','+1234567895',0,0),(7,'Antonio','Greco','1987-04-18','Via Genova 444','+1234567896',1,0),(8,'Chiara','Fontana','1993-12-05','Via Bologna 555','+1234567897',0,0),(9,'Stefano','Galli','1980-09-30','Via Verona 666','+1234567898',1,0),(10,'Alessia','Costa','1999-02-14','Via Bari 777','+1234567899',0,0);
...
INSERT INTO `delivery_person` VALUES (1,'Giovanni','Delivery','1234AB'),(2,'Francesco','Speed','5678CD'),(3,'Luca','Fast','9012EF');
...
INSERT INTO `ingredient` VALUES (1,'Tomato Sauce',1.50,1,1),(2,'Mozzarella',2.00,1,0),(3,'Pepperoni',2.50,0,0),(4,'Mushrooms',1.75,1,1),(5,'Bell Peppers',1.25,1,1),(6,'Onions',1.00,1,1),(7,'Olives',1.50,1,1),(8,'Ham',2.75,0,0),(9,'Pineapple',1.80,1,1),(10,'Basil',0.75,1,1);
...
INSERT INTO `menu_item` VALUES (1,'pizza',1),(2,'pizza',2),(3,'pizza',3),(4,'pizza',4),(5,'pizza',5),(6,'pizza',6),(7,'pizza',7),(8,'pizza',8),(9,'pizza',9),(10,'pizza',10),(11,'drink',1),(12,'drink',2),(13,'drink',3),(14,'dessert',1),(15,'dessert',2);
...
INSERT INTO `pizza` VALUES (1,'Margherita'),(2,'Pepperoni'),(3,'Veggie Deluxe'),(4,'Hawaiian'),(5,'Four Cheese'),(6,'Meat Feast'),(7,'BBQ Chicken'),(8,'Capricciosa'),(9,'Diavola'),(10,'Funghi');
...
-- Dump completed on 2025-10-01 13:12:49
